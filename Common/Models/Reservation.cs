...
public class Reservation
{
    ...
    {
        return
            $"{(DateTime.Today.Year != StartDate.Year ? StartDate.Year : string.Empty)} {StartDate:dddd, MMMM d} {StartDate:HH:mm} - {(DateTime.Today.Year != EndDate.Year ? EndDate.Year : string.Empty)} {(StartDate.Date == EndDate.Date ? string.Empty : $"{EndDate:dddd, MMMM d}")} {EndDate:HH:mm}";
    }
}